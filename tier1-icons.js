...
$_documentContainer.innerHTML = `<iron-iconset-svg name="d2l-tier1" size="18" rtl-mirroring="true" use-global-rtl-attribute="true">
  <svg>
    <defs>
      ...
      <g id="d2l-icon-add-message" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-add-to-lor" mirror-in-rtl="true">
        <g fill-rule="evenodd">
      ...
      <g id="d2l-icon-add-user" mirror-in-rtl="true">
        <path d="M4.614 0h-.228a3.27 3.27 0 0 0-3.261 3.261v1.353a3.27 3.27 0 0 0 3.261 3.261h.228a3.27 3.27 0 0 0 3.261-3.261V3.261A3.27 3.27 0 0 0 4.614 0zM18 13a1 1 0 0 1-1 1h-3v3a1 1 0 0 1-2 0v-3H9a1 1 0 0 1 0-2h3V9a1 1 0 0 1 2 0v3h3a1 1 0 0 1 1 1z"/>
        <path d="M6 13a2.994 2.994 0 0 1 1.677-2.679A4.494 4.494 0 0 0 0 13.5v3a1.491 1.491 0 0 0 1.5 1.49l6 .01A1.5 1.5 0 0 0 9 16.5V16a3 3 0 0 1-3-3z"/>
      </g>
      <g id="d2l-icon-add">
      ...
      <g id="d2l-icon-arrow-collapse-small">
        <path d="M10.708,0.29 C10.518,0.1 10.258,0 9.998,0 L2.002,0 C1.742,0 1.482,0.1 1.292,0.29 C0.902,0.69 0.902,1.32 1.292,1.71 L5.29,5.71 C5.49,5.9 5.74,6 6,6 C6.26,6 6.51,5.9 6.71,5.71 L10.708,1.71 C11.097,1.32 11.097,0.69 10.708,0.29 L10.708,0.29 Z"/>
      </g>
      <g id="d2l-icon-arrow-collapse">
        <path d="M17.707 5.707l-8 8a1 1 0 0 1-1.414 0l-8-8A1 1 0 0 1 1 4h16a1 1 0 0 1 .924.617A.97.97 0 0 1 18 5a1 1 0 0 1-.293.707z"/>
      </g>
      <g id="d2l-icon-arrow-expand-small" mirror-in-rtl="true">
        <path d="M6 14V6c0-.4.2-.8.6-.9s.8-.1 1.1.2l4 4c.4.4.4 1 0 1.4l-4 4c-.3.3-.7.4-1.1.2-.4-.1-.6-.5-.6-.9zm2-5.6v3.2L9.6 10 8 8.4z"/>
      </g>
      <g id="d2l-icon-arrow-expand" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-arrow-thin-down">
        <path d="M13.9 11.583a1 1 0 0 0-.9-.571h-3V1a1 1 0 1 0-2 0v10.012H5a1 1 0 0 0-.9.571.983.983 0 0 0 .12 1.051l4 5.006a1.024 1.024 0 0 0 1.56 0l4-5.006a.983.983 0 0 0 .12-1.051z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-arrow-thin-left">
        <path d="M6.417 4.1a1 1 0 0 1 .571.9v3H17a1 1 0 0 1 0 2H6.988v3a1 1 0 0 1-.571.9.983.983 0 0 1-1.051-.12l-5.006-4a1.024 1.024 0 0 1 0-1.56l5.006-4a.983.983 0 0 1 1.051-.12z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-arrow-thin-right">
        <path d="M11.583 4.1a1 1 0 0 0-.571.9v3H1a1 1 0 1 0 0 2h10.012v3a1 1 0 0 0 .571.9.983.983 0 0 0 1.051-.12l5.006-4a1.024 1.024 0 0 0 0-1.56l-5.006-4a.983.983 0 0 0-1.051-.12z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-arrow-thin-up">
        <path d="M13.9 6.417a1 1 0 0 1-.9.571h-3V17a1 1 0 0 1-2 0V6.988H5a1 1 0 0 1-.9-.571.983.983 0 0 1 .12-1.051l4-5.006a1.024 1.024 0 0 1 1.56 0l4 5.006a.983.983 0 0 1 .12 1.051z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-arrow-toggle-down">
      ...
      <g id="d2l-icon-blog" mirror-in-rtl="true">
        <g fill-rule="evenodd">
      ...
      <g id="d2l-icon-book-management">
        <path d="M10.05 3.66a1.114 1.114 0 0 1-.05-.31 1 1 0 0 1 .7-.95l1.95-.62a.992.992 0 0 1 1.25.65l3.08 9.64a1 1 0 0 1-.65 1.26l-1.95.62a1.047 1.047 0 0 1-.3.05 1 1 0 0 1-.95-.7z"/>
        <path d="M17 14H9a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1V1a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1H1a1 1 0 0 0 0 2v1a1 1 0 0 0 2 0v-1h12v1a1 1 0 0 0 2 0v-1a1 1 0 0 0 0-2z"/>
      </g>
      <g id="d2l-icon-bookmark-filled">
      ...
      <g id="d2l-icon-chat" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-check">
        <path d="M6.47 11.35l7.94-8.382c.57-.6 1.52-.627 2.122-.057.6.57.627 1.52.057 2.123l-9 9.5-.016.014-.014.015c-.58.582-1.52.586-2.106.015l-.02-.02-3.995-3.994c-.587-.585-.587-1.535 0-2.12.584-.586 1.534-.586 2.12 0l2.91 2.91z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-checklist" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-chevron-down-medium">
      ...
      <g id="d2l-icon-chevron-left" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-chevron-right" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-class">
        <path d="M1 0h1v9.688c0 .079.028.155.081.213a.3.3 0 0 0 .231.1.316.316 0 0 0 .213-.081L4.5 8l1.963 1.906.012.013a.316.316 0 0 0 .213.081.3.3 0 0 0 .231-.1A.314.314 0 0 0 7 9.688V0h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V1a1 1 0 0 1 1-1z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-classlist" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-close-circle">
        <path d="M9,0a9,9,0,1,0,9,9A9,9,0,0,0,9,0Zm4.707,12.293a1,1,0,1,1-1.414,1.414L9,10.414,5.707,13.707a1,1,0,0,1-1.414-1.414L7.586,9,4.293,5.707A1,1,0,0,1,5.707,4.293L9,7.586l3.293-3.293a1,1,0,0,1,1.414,1.414L10.414,9Z"/>
      </g>
      <g id="d2l-icon-close-default">
      ...
      <g id="d2l-icon-close-large-thick">
      ...
      <g id="d2l-icon-comment-filled">
        <path d="M15.3,2.02A2.845,2.845,0,0,0,15,2H3A3.009,3.009,0,0,0,0,5v5a3.009,3.009,0,0,0,3,3v2a1,1,0,0,0,.58.91A1.059,1.059,0,0,0,4,16a.969.969,0,0,0,.65-.24L7.84,13H15a2.829,2.829,0,0,0,.3-.02A3,3,0,0,0,18,10V5A3,3,0,0,0,15.3,2.02Z"/>
      </g>
      <g id="d2l-icon-comment-hollow">
      ...
      <g id="d2l-icon-contacts">
        ...
        <path d="M12.218 8.222a1.152 1.152 0 0 0-.37.27 1.3 1.3 0 0 0-.247.39 1.183 1.183 0 0 0-.092.457.562.562 0 0 0 .109.368.389.389 0 0 0 .318.131.76.76 0 0 0 .207-.03.576.576 0 0 0 .2-.106.8.8 0 0 0 .174-.2 1.144 1.144 0 0 0 .13-.314l.29-1.042a1.558 1.558 0 0 0-.262-.023 1.062 1.062 0 0 0-.457.099z"/>
      </g>
      <g id="d2l-icon-copy" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-course-tile-sort" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-disable">
        <path d="M16,4H8V14h8a2.006,2.006,0,0,0,2-2V6A2.006,2.006,0,0,0,16,4Zm-.293,6.293a1,1,0,1,1-1.414,1.414L13,10.414l-1.293,1.293a1,1,0,0,1-1.414-1.414L11.586,9,10.293,7.707a1,1,0,0,1,1.414-1.414L13,7.586l1.293-1.293a1,1,0,0,1,1.414,1.414L14.414,9Z"/>
        <rect y="3" width="6" height="12" rx="1" ry="1"/>
      </g>
      <g id="d2l-icon-discussions" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-divider-solid">
        <path d="M9 18c-.3 0-.5-.2-.5-.5V.5c0-.3.2-.5.5-.5s.5.2.5.5v17c0 .3-.2.5-.5.5z"/>
      </g>
      <g id="d2l-icon-dot">
        <circle cx="9" cy="9" r="4" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-download">
      ...
      <g id="d2l-icon-draft" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-dragger">
        <path d="M8 16v1c0 .5-.4 1-1 1H6c-.6 0-1-.5-1-1v-1c0-.6.4-1 1-1h1c.6 0 1 .4 1 1M13 16v1c0 .5-.4 1-1 1h-1c-.6 0-1-.5-1-1v-1c0-.6.4-1 1-1h1c.6 0 1 .4 1 1M8 11v1c0 .6-.4 1-1 1H6c-.6 0-1-.4-1-1v-1c0-.6.4-1 1-1h1c.6 0 1 .4 1 1M13 11v1c0 .6-.4 1-1 1h-1c-.6 0-1-.4-1-1v-1c0-.6.4-1 1-1h1c.6 0 1 .4 1 1M8 6v1c0 .6-.4 1-1 1H6c-.6 0-1-.4-1-1V6c0-.6.4-1 1-1h1c.6 0 1 .4 1 1M13 6v1c0 .6-.4 1-1 1h-1c-.6 0-1-.4-1-1V6c0-.6.4-1 1-1h1c.6 0 1 .4 1 1M8 1v1c0 .6-.4 1-1 1H6c-.6 0-1-.4-1-1V1c0-.5.4-1 1-1h1c.6 0 1 .5 1 1M13 1v1c0 .6-.4 1-1 1h-1c-.6 0-1-.4-1-1V1c0-.5.4-1 1-1h1c.6 0 1 .5 1 1"/>
      </g>
      <g id="d2l-icon-edit-bulk">
      ...
      <g id="d2l-icon-email-read" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-enable">
        <rect x="12" y="3" width="6" height="12" rx="1" ry="1"/>
      ...
      <g id="d2l-icon-exemption-remove">
        <path d="M18 1v3a1 1 0 0 1-2 0v-.58l-.15.15-1.06 1.05-.36.36a1 1 0 0 1-1.41-1.41l.36-.36 1.05-1.06.01-.01.14-.14H14a1 1 0 0 1 0-2h3a1 1 0 0 1 1 1z"/>
        <rect x=".706" y="14.294" width="2" height="4" rx="1" ry="1" transform="rotate(45 1.706 16.294)"/>
        <rect x="4.949" y="10.051" width="2" height="4" rx="1" ry="1" transform="rotate(45 5.948 12.052)"/>
        <rect x="9.191" y="5.809" width="2" height="4" rx="1" ry="1" transform="rotate(45 10.191 7.81)"/>
      </g>
      <g id="d2l-icon-export" mirror-in-rtl="true">
        ...
        <path d="M18 8a.34.34 0 0 1-.01.1V17a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1l.01-9a1 1 0 1 1 2 0 .34.34 0 0 1-.01.1V16h13.99V8H16a1 1 0 1 1 2 0z"/>
      </g>
      <g id="d2l-icon-external">
        <g fill-rule="evenodd">
          <path d="M13 0a1 1 0 0 1 1 1 1.02 1.02 0 0 1-.379.79l-.06.04A6.174 6.174 0 0 0 11.14 5a3.672 3.672 0 0 0-.15 1h1.017c.37.003.707.216.868.55a1 1 0 0 1-.09 1.05l-2.992 4a1 1 0 0 1-1.6 0l-2.992-4a.992.992 0 0 1-.09-1.05.985.985 0 0 1 .873-.55H7c0-2.15 3.093-5.91 6-6z"/>
          <path d="M18 8a.34.34 0 0 1-.01.1V17a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1l.01-9a1 1 0 1 1 2 0 .34.34 0 0 1-.01.1V16h13.991V8H16a1 1 0 0 1 2 0z"/>
        </g>
      </g>
      <g id="d2l-icon-feed">
      ...
      <g id="d2l-icon-feedback" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-file-document" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-file-presentation" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-folder-up-level">
        <path d="M18 5v4c-.8-.6-2-1-3-1-2.8 0-5 2.2-5 5 0 1 .4 2.2 1 3H1c-.6 0-1-.5-1-1V3c0-.6.5-1 1-1h7c.5 0 1 .4 1 1v1h8c.6 0 1 .5 1 1z"/>
        <path d="M17.7 13.7c-.2.2-.5.3-.7.3-.3 0-.5 0-.7-.3l-.3-.3V17c0 .6-.5 1-1 1s-1-.5-1-1v-3.6l-.3.3c-.2.2-.5.3-.7.3-.3 0-.5 0-.7-.3-.4-.4-.4-1 0-1.4l2-2c.4-.4 1-.4 1.4 0l2 2c.4.4.4 1 0 1.4z"/>
      </g>
      <g id="d2l-icon-folder">
        <path d="M18 5v10a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h7.01a.99.99 0 0 1 .99.9V4h8a1 1 0 0 1 1 1z"/>
      </g>
      <g id="d2l-icon-forms" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-forward" mirror-in-rtl="true">
        <path d="M12.29,11.3a1.0077,1.0077,0,0,0,0,1.42.9674.9674,0,0,0,.69.28H13a1.22,1.22,0,0,0,.55-.17c.01-.01.14-.09.16-.11L17.6,9.8a1.0243,1.0243,0,0,0,.4-.79V9a1.044,1.044,0,0,0-.4-.8L13.71,5.28c-.02-.02-.15-.1-.16-.11A1.1047,1.1047,0,0,0,13.03,5H13a.99.99,0,0,0-.71,1.7l.05.05,1.17,1.14A1.4937,1.4937,0,0,1,14,9h0a1.4937,1.4937,0,0,1-.49,1.11l-1.17,1.14Z"/>
        <path d="M0,9a1.0029,1.0029,0,0,0,1,1H6v2.02a.9761.9761,0,0,0,.55.87A.9964.9964,0,0,0,7.6,12.8l4-3a1,1,0,0,0,0-1.6l-4-3a.99.99,0,0,0-1.05-.09A.9876.9876,0,0,0,6,5.98V8H1A1.0029,1.0029,0,0,0,0,9Z"/>
      </g>
      <g id="d2l-icon-fullscreen">
      ...
      <g id="d2l-icon-grade-remove">
        ...
        <rect x="9" y="12" width="7" height="2" rx="1" ry="1"/>
      </g>
      <g id="d2l-icon-grade-visible">
      ...
      <g id="d2l-icon-group">
        ...
        <path d="M9.1 0h-.2C7.3.004 6.003 1.3 6 2.9v1.2C6.004 5.7 7.3 6.996 8.9 7h.2c1.6-.004 2.896-1.3 2.9-2.9V2.9C11.996 1.3 10.7.003 9.1 0zM11 18H7c-1.1 0-2-.9-2-2v-4c0-2.2 1.8-4 4-4s4 1.8 4 4v4c0 1.1-.9 2-2 2z"/>
      </g>
      <g id="d2l-icon-help">
      ...
      <g id="d2l-icon-import" mirror-in-rtl="true">
        <path d="M13 0c.552 0 1 .448 1 1 0 .307-.14.597-.38.79l-.06.04c-1.135.76-1.986 1.875-2.42 3.17-.096.325-.146.66-.15 1h1.017c.37.003.707.216.868.55.172.34.137.745-.09 1.05l-2.992 4c-.19.252-.485.4-.8.4-.315 0-.61-.148-.8-.4L5.2 7.6c-.228-.304-.263-.712-.09-1.05.165-.333.503-.546.874-.55H7c0-2.15 3.093-5.91 6-6z"/>
        <path d="M18 8c.002.034-.002.067-.01.1V17c0 .552-.448 1-1 1H1c-.552 0-1-.448-1-1l.01-9c0-.357.19-.687.5-.866.31-.18.69-.18 1 0 .31.18.5.51.5.866.002.034-.002.067-.01.1V16h13.99V8H16c0-.552.448-1 1-1s1 .448 1 1z"/>
      </g>
      <g id="d2l-icon-important">
      ...
      <g id="d2l-icon-location">
        <path d="M9 0a7 7 0 0 0-7 7v.04a6.863 6.863 0 0 0 1.09 3.7l.6.81L8.2 17.6a1 1 0 0 0 1.6 0l4.51-6.05.6-.81A6.863 6.863 0 0 0 16 7.04V7a7 7 0 0 0-7-7zm0 11a4 4 0 1 1 0-8 4 4 0 0 1 0 8z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-locations">
      ...
      <g id="d2l-icon-locker">
        <path d="M11.764 0H6.236A2.243 2.243 0 0 0 4 2.236v13.528A2.243 2.243 0 0 0 6.236 18h5.528A2.243 2.243 0 0 0 14 15.764V2.236A2.243 2.243 0 0 0 11.764 0zM7.96 13a1 1 0 0 1-2 0v-2a1 1 0 0 1 2 0v2zm2.894-8.854l1 1A.5.5 0 0 1 11.5 6h-1a.5.5 0 0 1 .354.146l1 1A.5.5 0 0 1 11.5 8h-5a.5.5 0 0 1-.354-.854l1-1A.5.5 0 0 1 7.5 6h-1a.5.5 0 0 1-.354-.854l1-1A.5.5 0 0 1 7.5 4h-1a.5.5 0 0 1-.354-.854l1-1A.5.5 0 0 1 7.5 2h3a.5.5 0 0 1 .354.146l1 1A.5.5 0 0 1 11.5 4h-1a.5.5 0 0 1 .354.146z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-lor">
        <path d="M17 12h-1V3a.522.522 0 0 0-.32-.47L9.18.03a.554.554 0 0 0-.36 0l-6.5 2.5A.522.522 0 0 0 2 3v9H1a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1zM6 12H4V6h2v6zm4 0H8V6h2v6zm2-6h2v6h-2V6z"/>
      </g>
      <g id="d2l-icon-low-priority">
        <path d="M17.6,11.8l-8,6a1,1,0,0,1-1.2,0l-8-6a1.0226,1.0226,0,0,1-.35-1.12A1.0135,1.0135,0,0,1,1,10H3V9A1.0029,1.0029,0,0,1,4,8H14a1.0029,1.0029,0,0,1,1,1v1h2a.9989.9989,0,0,1,.6,1.8Z"/>
        <rect x="3" y="4" width="12" height="2" rx="1" ry="1"/>
        <rect x="3" width="12" height="2" rx="1" ry="1"/>
      </g>
      <g id="d2l-icon-manage-dates-edit">
        <path d="M18,12.382V17a1,1,0,0,1-1,1H12.277c.142-.125.278-.252.407-.379L14.329,16H16V14.353Zm0-6.17a3.129,3.129,0,0,0-3.328.685L13.553,8H2v8H6.3a3.49,3.49,0,0,0-.283,2H1a1,1,0,0,1-1-1V4A1,1,0,0,1,1,3H4V1A1,1,0,0,1,6,1V3h6V1a1,1,0,0,1,2,0V3h3a1,1,0,0,1,1,1V6.212Z"/>
        <path d="M17.675,9.9l-6.4,6.3c-.437.431-2.762,2.005-3.2,1.571s1.169-2.714,1.6-3.145l6.4-6.3a1.135,1.135,0,0,1,1.59.008A1.1,1.1,0,0,1,17.675,9.9Z"/>
      </g>
      <g id="d2l-icon-manage-dates-offset">
        <path d="M18,12.45V4a1,1,0,0,0-1-1H14V1a1,1,0,0,0-2,0V3H6V1A1,1,0,0,0,4,1V3H1A1,1,0,0,0,0,4V17a1,1,0,0,0,1,1h9.287a2.952,2.952,0,0,1-1.261-2H2V8H16v3.067a2.9,2.9,0,0,1,1.4.785Z"/>
        <path d="M17.388,16.429l-.875.875-.438.437a1.167,1.167,0,0,1-.7.263.525.525,0,0,1-.35-.088.764.764,0,0,1-.525-.787v-.875H11.875a.875.875,0,0,1,0-1.75H14.5v-.875a.766.766,0,0,1,.525-.788.8.8,0,0,1,.963.175L17.475,14.5a1.028,1.028,0,0,1,.525.875C18,15.816,17.65,16.079,17.388,16.429Z"/>
        <path d="M6.613,13.179l.875.875.437.437a1.167,1.167,0,0,0,.7.263.525.525,0,0,0,.35-.088.764.764,0,0,0,.525-.787V13h2.625A.942.942,0,0,0,13,12.129a.941.941,0,0,0-.875-.875H9.5v-.875a.766.766,0,0,0-.525-.788.8.8,0,0,0-.963.175L6.525,11.254A1.026,1.026,0,0,0,6,12.129C6,12.566,6.35,12.829,6.613,13.179Z"/>
      </g>
      <g id="d2l-icon-manage-dates">
        <g fill-rule="evenodd">
      ...
      <g id="d2l-icon-manual-run">
        ...
        <path d="M17.72,13a.479.479,0,0,1-.19.39l-4.71,3.93a.517.517,0,0,1-.32.11.5.5,0,0,1-.5-.5V9.04a.5.5,0,0,1,.5-.47.522.522,0,0,1,.31.1l4.72,3.94A.479.479,0,0,1,17.72,13Z"/>
      </g>
      <g id="d2l-icon-menu-hamburger">
      ...
      <g id="d2l-icon-move-down" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-move-to" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-move-up" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-new-window" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-password">
        <path d="M17.408 3.412a1.974 1.974 0 0 0 0-2.82 1.973 1.973 0 0 0-2.819 0l-.29.29-.59-.59a1.009 1.009 0 0 0-1.65.35l-.35-.35a1.004 1.004 0 1 0-1.42 1.42l.35.35a1.033 1.033 0 0 0-.58.58l-.35-.35a1.004 1.004 0 0 0-1.42 1.42L9.879 5.3l-3.02 3.01c-.01.01-.02.03-.03.04A4.885 4.885 0 0 0 5 8a5 5 0 1 0 5 5 4.885 4.885 0 0 0-.35-1.83c.01-.01.03-.02.04-.03l7.718-7.728zM5 15a2 2 0 1 1 0-4 2 2 0 0 1 0 4z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-pic">
      ...
      <g id="d2l-icon-publish-to-lor">
        <g fill-rule="evenodd">
          <path d="M17.892 14.45a.982.982 0 0 1-1.329.44l-.537-.27V17a1.006 1.006 0 0 1-2.011 0v-2.38l-.559.27a1 1 0 0 1-.91-1.78l.931-.465.664-.332c.277-.187.6-.296.933-.313a2.1 2.1 0 0 1 .743.289l.667.333c.322.161.644.325.968.483a.992.992 0 0 1 .44 1.345z"/>
          <path d="M15.68 2.53L9.18.03a.555.555 0 0 0-.36 0l-6.5 2.5A.511.511 0 0 0 2 3v9H1a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h10.02a4.945 4.945 0 0 1 .98-6.98V6h2v4.1a5.051 5.051 0 0 1 2 0V3a.511.511 0 0 0-.32-.47zM6 12H4V6h2v6zm4 0H8V6h2v6z"/>
        </g>
      </g>
      <g id="d2l-icon-quicklink">
        <path d="M10,7.993a1.6,1.6,0,0,1-.359.85l-.419.593-5.728,8.1a.929.929,0,0,1-.764.457.9.9,0,0,1-.71-.38,1.038,1.038,0,0,1-.2-.62,1.411,1.411,0,0,1,.137-.537l.13-.318c.071-.175,2.1-5.145,2.113-5.145-.289,0-3.047.016-3.335,0A.978.978,0,0,1,0,10.084,1.739,1.739,0,0,1,.5,8.942L6.224.856A3.41,3.41,0,0,1,6.763.175.865.865,0,0,1,8.042.446a1.76,1.76,0,0,1-.18,1.583L5.934,6.993H8.488a2.247,2.247,0,0,1,1,.1.959.959,0,0,1,.5.746A.945.945,0,0,1,10,7.993Z"/>
        <path d="M18,6V3a3,3,0,0,0-6,0V6a3,3,0,0,0,2,2.82v.3a3,3,0,0,0-2,2.82v3a3,3,0,0,0,6,0v-3a3,3,0,0,0-2-2.82v-.3A3,3,0,0,0,18,6ZM14,3a1,1,0,0,1,2,0V6a1,1,0,0,0-2,0Zm2,11.94a1,1,0,0,1-2,0V12a1,1,0,0,0,2,0Z"/>
      </g>
      <g id="d2l-icon-quizzing">
      ...
      <g id="d2l-icon-read-unread" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-redo" mirror-in-rtl="true">
        <path d="M0 10c0 4.41 3.59 8 8 8s8-3.59 8-8c0-.55-.45-1-1-1s-1 .45-1 1c0 3.31-2.69 6-6 6s-6-2.69-6-6 2.69-6 6-6h4v1c0 .37.2.71.53.88.15.08.31.12.47.12.19 0 .39-.06.55-.17l3-2c.28-.18.45-.5.45-.83 0-.33-.17-.65-.45-.83l-3-2C13.39.06 13.19 0 13 0c-.16 0-.32.04-.47.12C12.2.29 12 .63 12 1v1H8c-4.41 0-8 3.59-8 8z"/>
      </g>
      <g id="d2l-icon-reflection" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-release-conditions">
      ...
      <g id="d2l-icon-reply" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-reporting" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-resize-left" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-resize-right" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-reverse-order">
        <path d="M17.6,4.2l-4-3a1,1,0,0,0-1.05-.09A.977.977,0,0,0,12,2V4H1A1,1,0,0,0,1,6H12V8a.988.988,0,0,0,.55.89A.99.99,0,0,0,13.6,8.8l4-3a1,1,0,0,0,0-1.6Z"/>
        <path d="M.4,12.2l4-3a1,1,0,0,1,1.05-.09A.977.977,0,0,1,6,10v2H17a1,1,0,0,1,0,2H6v2a.988.988,0,0,1-.55.89A.99.99,0,0,1,4.4,16.8l-4-3a1,1,0,0,1,0-1.6Z"/>
      </g>
      <g id="d2l-icon-role-switch">
        <path d="M11.707 1.712l-4 4L4.419 9l1.29 1.29a1 1 0 0 1 .21 1.09A.987.987 0 0 1 5 12H1a1 1 0 0 1-1-1V7a.987.987 0 0 1 .62-.92 1 1 0 0 1 1.09.21L3 7.581l3.289-3.289 4-4a1.003 1.003 0 0 1 1.418 1.42zM6.293 16.288l4-4L13.581 9l-1.29-1.29a1 1 0 0 1-.21-1.09A.987.987 0 0 1 13 6h4a1 1 0 0 1 1 1v4a.987.987 0 0 1-.62.92 1 1 0 0 1-1.09-.21L15 10.419l-3.289 3.289-4 4a1.003 1.003 0 0 1-1.418-1.42z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-rss">
      ...
      <g id="d2l-icon-scorm">
        <path d="M17 4.1H1c-.6 0-1 .4-1 1 0 .5.4 1 1 1V14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6.1c.5 0 1-.5 1-1 0-.6-.5-1-1-1zM8.1 9.7c0 .6-.5 1-1 1h-2c-.5 0-1-.4-1-1v-1c0-.5.5-1 1-1h2c.5 0 1 .5 1 1v1z"/>
      </g>
      <g id="d2l-icon-search">
      ...
      <g id="d2l-icon-share-parent-filled">
        <path d="M14,10H11.44c-.081,0-.157.019-.237.024A5.956,5.956,0,0,1,12,13v3a3.954,3.954,0,0,1-.142,1H17a1,1,0,0,0,1-1V14A4.012,4.012,0,0,0,14,10Z"/>
        <path d="M5,0A3.009,3.009,0,0,0,2,3V5A3,3,0,0,0,8,5V3A3.009,3.009,0,0,0,5,0Z"/>
        <path d="M13,2a3.009,3.009,0,0,0-3,3V6a3,3,0,0,0,6,0V5A3.009,3.009,0,0,0,13,2Z"/>
        <path d="M6,9H4a4.012,4.012,0,0,0-4,4v3a2.006,2.006,0,0,0,2,2H8a2.006,2.006,0,0,0,2-2V13A4.012,4.012,0,0,0,6,9Z"/>
      </g>
      <g id="d2l-icon-share-parent-hollow">
        <path d="M14,10H11.44c-.081,0-.157.019-.237.024A5.956,5.956,0,0,1,12,13v3a3.954,3.954,0,0,1-.142,1H17a1,1,0,0,0,1-1V14A4.012,4.012,0,0,0,14,10Zm2,5H14V12a2.006,2.006,0,0,1,2,2Z"/>
        <path d="M5,0A3.009,3.009,0,0,0,2,3V5A3,3,0,0,0,8,5V3A3.009,3.009,0,0,0,5,0ZM6,5A1,1,0,0,1,4,5V3A1,1,0,0,1,6,3Z"/>
        <path d="M13,2a3.009,3.009,0,0,0-3,3V6a3,3,0,0,0,6,0V5A3.009,3.009,0,0,0,13,2Zm1,4a1,1,0,0,1-2,0V5a1,1,0,0,1,2,0Z"/>
        <path d="M6,11a2,2,0,0,1,2,2v3H2V13a2,2,0,0,1,2-2ZM6,9H4a4.012,4.012,0,0,0-4,4v3a2.006,2.006,0,0,0,2,2H8a2.006,2.006,0,0,0,2-2V13A4.012,4.012,0,0,0,6,9Z"/>
      </g>
      <g id="d2l-icon-share" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-sort-type" mirror-in-rtl="true">
        <g fill-rule="nonzero">
      ...
      <g id="d2l-icon-specialaccess">
        <path d="M13,0A5,5,0,0,0,8,5a4.88,4.88,0,0,0,.35,1.829c-.01.01-.03.02-.04.03L4.3,10.881,2.707,9.293a1,1,0,0,0-1.414,1.414L2.882,12.3l-.585.587-.59-.589A1,1,0,1,0,.293,13.708l.591.59-.29.291a1.974,1.974,0,0,0,0,2.819,1.975,1.975,0,0,0,2.82,0L11.141,9.69c.01-.01.02-.03.03-.04A4.881,4.881,0,0,0,13,10,5,5,0,0,0,13,0Zm0,7a2,2,0,1,1,2-2A2,2,0,0,1,13,7Z"/>
      </g>
      <g id="d2l-icon-spellcheck">
        <path d="M9.912 9.59l-4-9a1 1 0 0 0-1.82-.01v.01l-.02.04L.09 9.59a.993.993 0 0 0 .5 1.32A1.013 1.013 0 0 0 1 11a.992.992 0 0 0 .91-.59L2.54 9h4.92l.63 1.41A.992.992 0 0 0 9 11a1.013 1.013 0 0 0 .41-.09.992.992 0 0 0 .502-1.32zM3.43 7L5 3.46 6.57 7H3.43z"/>
        <path d="M17.805 6.6L9.93 17.43a1.142 1.142 0 0 1-.942.57 1.417 1.417 0 0 1-.982-.576L4.292 13.71a1.004 1.004 0 0 1 1.42-1.42l3.17 3.17 7.3-10.04a1.003 1.003 0 1 1 1.623 1.18z"/>
      </g>
      <g id="d2l-icon-style">
        <path d="M17.5.381a1.5 1.5 0 0 1 .119 2.119l-9 10a1.14 1.14 0 0 1-.2.18 5.116 5.116 0 0 1-.69 2.54 4.1 4.1 0 0 1-.7.9c-2.2 2.21-6.529 2.25-7 1.26-.15-.33.22-.57 1.31-2.45 1.3-2.27 1.4-3 1.95-3.55.099-.103.21-.194.33-.27a4.092 4.092 0 0 1 2.76-.7l.04.04L15.379.5A1.5 1.5 0 0 1 17.5.381z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-subscribe-filled">
      ...
      <g id="d2l-icon-subscribe-hollow">
      ...
      <g id="d2l-icon-support">
        <path d="M16 7.184C16 3.14 12.86 0 9 0S2 3.14 2 7c-1.163.597-2 1.696-2 3v2a3 3 0 0 0 3 3h1a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1 5 5 0 0 1 10 0 1 1 0 0 0-1 1v6a1 1 0 0 0 1 1v1h-2.592c-.206-.581-.756-1-1.408-1H8a1.5 1.5 0 0 0 0 3h6a2 2 0 0 0 2-2v-1.183A2.992 2.992 0 0 0 18 12v-2a2.99 2.99 0 0 0-2-2.816L-7 62" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-surveys" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-tag-hollow">
        ...
        <path d="M14.25,3.019a.731.731,0,1,0,.731.731.731.731,0,0,0-.731-.731Z"/>
      </g>
      <g id="d2l-icon-tag">
      ...
      <g id="d2l-icon-tools">
        <path d="M13.333 4.667a2.014 2.014 0 0 1 0-2.849L15.015.136A4.009 4.009 0 0 0 10.1 5.055l-5.031 5.028a4.029 4.029 0 1 0 2.849 2.849L12.945 7.9a4.009 4.009 0 0 0 4.918-4.918l-1.682 1.685a2.014 2.014 0 0 1-2.848 0zM5.4 15.452a2.014 2.014 0 1 1 0-2.849 2.014 2.014 0 0 1 0 2.849z"/>
      </g>
      <g id="d2l-icon-topic-last" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-turnitin">
        <path d="M17.44,13.26l-.31-.36-1.69-1.96a2,2,0,0,0-.19-.22,2.235,2.235,0,0,0-.73-.49A2.345,2.345,0,0,0,13.5,10a2.5,2.5,0,0,0-1.99,1H10.49A2.5,2.5,0,0,0,8.5,10a2.345,2.345,0,0,0-1.02.23,2.235,2.235,0,0,0-.73.49,2,2,0,0,0-.19.22L4.87,12.9l-.31.36A2.985,2.985,0,0,0,4,15a.859.859,0,0,0,.01.16A2.991,2.991,0,0,0,9.82,16h2.36a2.991,2.991,0,0,0,5.81-.84A.859.859,0,0,0,18,15,2.985,2.985,0,0,0,17.44,13.26ZM7,16a1,1,0,1,1,1-1A1,1,0,0,1,7,16Zm8,0a1,1,0,1,1,1-1A1,1,0,0,1,15,16Z"/>
        <path d="M9.85,3.15,6.86.15A.507.507,0,0,0,6.5,0H1.4A1.417,1.417,0,0,0,0,1.43V12.57A1.417,1.417,0,0,0,1.4,14h.862a7.939,7.939,0,0,1,.817-2H3a1,1,0,0,1,0-2H4.721A7.96,7.96,0,0,1,10,8V3.5A.469.469,0,0,0,9.85,3.15ZM3,2H4A1,1,0,0,1,4,4H3A1,1,0,0,1,3,2ZM7,8H3A1,1,0,0,1,3,6H7A1,1,0,0,1,7,8Z"/>
      </g>
      <g id="d2l-icon-unapproved">
        <g fill-rule="evenodd">
      ...
      <g id="d2l-icon-undo" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-user-competencies">
        <path d="M17.692 13.93l-7-11a2 2 0 0 0-3.38 0l-7 11A2 2 0 0 0 2 17h14a2 2 0 0 0 1.692-3.07zM11 7a1 1 0 1 1 0 2 1 1 0 0 1 0-2zM9 4a1 1 0 1 1 0 2 1 1 0 0 1 0-2zM7 7a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm-4 8a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm2-3a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm2 3a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm2-3a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm2 3a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm2-3a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm2 3a1 1 0 1 1 0-2 1 1 0 0 1 0 2z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-user-progress" mirror-in-rtl="true">
        <g fill-rule="evenodd">
      ...
      <g id="d2l-icon-visibility-conditional">
        ...
        <path d="M4.943,11.909h0c.03-.053.055-.108.088-.16C5,11.8,4.973,11.856,4.943,11.909Z"/>
        <path d="M6.17,12.792a3.659,3.659,0,0,1,1.752-1.571A3.659,3.659,0,0,0,6.17,12.792Z"/>
        <path d="M6.042,10.639a6.922,6.922,0,0,1,1.991-1.1A6.922,6.922,0,0,0,6.042,10.639Z"/>
        <path d="M11.12,9C7.4,9,4.38,11.02,4.38,13.5S7.4,18,11.12,18s6.76-2.02,6.76-4.5S14.85,9,11.12,9ZM8.78,15.67c-1.43-.43-2.4-1.24-2.4-2.17s.97-1.74,2.4-2.17a3.9,3.9,0,0,0,0,4.34ZM12,14a1,1,0,1,1,1-1A1,1,0,0,1,12,14Zm1.46,1.68a3.93,3.93,0,0,0,0-4.36c1.45.43,2.42,1.25,2.42,2.18S14.91,15.25,13.46,15.68Z"/>
      </g>
      <g id="d2l-icon-visibility-hide" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-volume" mirror-in-rtl="true">
      ...
      <g id="d2l-icon-zoom-in">
        <path d="M17.422 14.592l-2.83-2.83a1.948 1.948 0 0 0-1.42-.58 1.78 1.78 0 0 0-.51.06l-.91-.91A6.41 6.41 0 0 0 13 6.5 6.5 6.5 0 1 0 6.5 13a6.414 6.414 0 0 0 3.831-1.25l.91.91c-.178.69.02 1.423.52 1.93l2.83 2.83a2 2 0 1 0 2.831-2.828zM9.5 8H8v1.5a1.5 1.5 0 0 1-3 0V8H3.5a1.5 1.5 0 0 1 0-3H5V3.5a1.5 1.5 0 0 1 3 0V5h1.5a1.5 1.5 0 0 1 0 3z" fill-rule="evenodd"/>
      </g>
      <g id="d2l-icon-zoom-out">
        <path d="M17.422 14.592l-2.83-2.83a1.948 1.948 0 0 0-1.42-.58 1.78 1.78 0 0 0-.51.06l-.91-.91A6.41 6.41 0 0 0 13 6.5 6.5 6.5 0 1 0 6.5 13a6.414 6.414 0 0 0 3.831-1.25l.91.91c-.178.69.02 1.423.52 1.93l2.83 2.83a2 2 0 1 0 2.831-2.828zM9.5 8h-6a1.5 1.5 0 0 1 0-3h6a1.5 1.5 0 0 1 0 3z" fill-rule="evenodd"/>
      </g>
    </defs>
  </svg>
</iron-iconset-svg>`;
